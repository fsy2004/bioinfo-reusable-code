...
Compute set union and intersection, then render a Venn diagram via `venn_pub`, a set-size bar chart, and an UpSet plot. Uses the same engine as [003](../003_CTD_Swiss靶点并集Venn/).
