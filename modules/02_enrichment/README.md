...
|--------|---------|----------|----------------|
| [007 GO/KEGG enrichment](007_go_kegg_enrichment/) | GO (BP/CC/MF) and KEGG pathway enrichment | R | GO faceted dot plot, KEGG lollipop, gene-pathway network |

```bash
Rscript 007_go_kegg_enrichment/007_GO_KEGG_enrichment.R                 # 跑示例
Rscript 007_go_kegg_enrichment/007_GO_KEGG_enrichment.R --input data/genes.csv
```
